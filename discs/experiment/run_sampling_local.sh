...
python -m discs.experiment.main_sampling \
   ...
   --num_instances=20 --num_models=1 --batch_size=31 --chain_length=100000 \
   --t_schedule=pt --init_temperature=100 --decay_rate=0.1 --final_temperature=0.0 \
   --pt=deo --pt_interval=100 --t_min=20 --t_max=50
